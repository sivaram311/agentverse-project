...
- Public smoke: `https://agentverse-staging.delena.buzz/health` (0.3.2) — **Q1_PREPROD_OK_035**
- **0.3.2:** PROD infrastructure 100% + 2 team pods only (Alpha/Beta); no Expanded HQ meeting/glass/elevators
