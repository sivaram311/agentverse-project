...
- Release: `H:\releases\agentverse-0.2.6\`
- Start: `F:\apps\agentverse\start.ps1 -EnvName preprod`
- Evidence: `H:\releases\agentverse-0.2.6\evidence\q1\`
- Auth: CSS clientId `agent-portal` (shared)
- DNS: Cloudflare A `agentverse-staging.delena.buzz` → `103.118.183.185` (proxied)
- Public smoke: `https://agentverse-staging.delena.buzz/health` (0.2.6) — **Q1_PREPROD_OK_026**
...
- **Mobile:** boosted lights + walkers; 10 team pods; companion **Mathura**.
