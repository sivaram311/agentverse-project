...
**Status:** PREPROD **0.3.13** (Intellect benches + freestyle cams + PROD dark shell) · PROD still **0.2.2** (2026-07-14)  
...
**Legacy (not mounted in HubScene 0.3.13):** `HexCollabOffice`, `TeamCluster`, `CentralConference`, `GlassCube`, `ElevatorShaft`, `DeskCluster` ProjectCluster — keep for restore.
