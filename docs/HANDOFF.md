...
**When:** 2026-07-15  
**Branch:** `feature/upgradation-functionality` · **Version:** **`v0.3.8` LIVE** (F+G)  
**Side ports:** **3312 / 4312 / 5312**  
**Hosts:** https://agentverse-upgrade-staging.delena.buzz · https://agentverse-upgrade.delena.buzz  
**IdP:** css-next (`https://css-next.delena.buzz` / `:5910`) · clientId `agent-portal`

## Live (after this cut)

| Env | Version | Evidence |
|-----|---------|----------|
| F PREPROD `:4312` | **0.3.8** | `H:\releases\agentverse-upgrade-0.3.8\` |
| G PROD `:5312` | **0.3.8** | same |
...
- **0.3.8** — IdP flip to **css-next** (lockstep Portal); classic CSS unchanged for densify fleet
